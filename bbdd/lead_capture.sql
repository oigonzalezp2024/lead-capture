...
INSERT INTO `lead_survey_questions` (`id_question`, `codigo_pregunta`, `route`, `question_text`, `question_type`, `orden`) VALUES
(2, 'Q2', 'COMMON', '¿Cuál es tu rol en este proyecto?', 'choice', 1);

INSERT INTO `lead_question_options` (`id_option`, `id_question`, `option_label`, `option_value`, `next_route_map`) VALUES
